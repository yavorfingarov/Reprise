namespace Reprise.UnitTests.Features.OpenApi.ExcludeFromDescription
{
    [UsesVerify]
    public class ExcludeFromDescriptionProcessorTests
    {
        ...
        public ExcludeFromDescriptionProcessorTests()
        {
